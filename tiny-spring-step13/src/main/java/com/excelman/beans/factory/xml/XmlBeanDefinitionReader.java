package com.excelman.beans.factory.xml;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException, DocumentException {
        ...
        // 一、通过扫描注解component进行注册BeanDefinition
        ...
        // 二、通过读取解析xml配置文件的bean进行注册BeanDefinition
    ...
    /**
     * 创建ClassPathBeanDefinitionScanner，调用doScan方法，扫描指定路径的所有component并注册到容器中
     * @param scanPath 即basePackages
     */
